...
public class AccesHTTP extends AsyncTask<String, Integer, Long> {
	...
	protected void onPostExecute(Long result) {
		...
		try {
			JSONObject retour = new JSONObject(this.ret.toString());
			String message = retour.optString("message", "");
			String resultat = retour.optString("result", "");
			delegate.processFinish(this.ret.toString(), message, resultat);
		} catch (JSONException e) {
			e.printStackTrace();
			delegate.processFinish(this.ret.toString(), "erreur", "");
		}
